...
export const faqData: FaqItemProps[] = [
  ...
  },
  {
    ...
    answer: 'No, we use OAuth 2.0 for authentication, which means we never see or store your passwords. We only request the minimum permissions needed to transfer your playlists.'
  },
  {
    id: 'songs-not-found',
