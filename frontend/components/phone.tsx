...
import { CheckCircle, ArrowRightLeft, Youtube as YoutubeIcon } from "lucide-react";
...
export default function Phone(area: areaProps) {
    ...
    return (
        <div className={`relative w-[${width}px] h-[${height}px] md:w-[${width + (0.1 * width)}px] md:h-[${height + (0.10 * height)}px]`}>
            {/* Phone mockup */}
